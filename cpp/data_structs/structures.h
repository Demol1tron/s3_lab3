...
class T {
    ...
    void printTreeVisual(const TNode *node, const std::string &prefix, bool isLeft) const;
...
struct NamedStructure {
    ...
    NamedStructure(std::string n, StructType t, void* s) : name(n), type(t), structure(s) {}
};
